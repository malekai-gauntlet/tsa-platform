...
function SettingsContent() {
  ...
  const loadUserData = async () => {
    try {
      ...
      setFormData({
        schoolName: cachedData?.schoolName || profilePreferences.schoolName || 'Texas Sports Academy',
        schoolBio: cachedData?.schoolBio || profileData?.bio || 'Developing student-athletes through excellence in education and athletics.',
        schoolEmail: cachedData?.schoolEmail || profilePreferences.schoolEmail || coachData?.email || email,
        ...
        googleCalendarEnabled: cachedData?.googleCalendarEnabled !== undefined ? cachedData.googleCalendarEnabled : (profilePreferences.googleCalendarEnabled || false),
  ...
  const handleRemovePhoto = async () => {
    ...
    try {
      ...
      // Dispatch event to update sidebar photo
      window.dispatchEvent(new CustomEvent('profilePhotoChange', { detail: '/default-profile.png' }))
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      try {
        localStorage.setItem('coach_settings_cache', JSON.stringify({
          ...savedData,
    ...
    <form method="post" className="mx-auto max-w-4xl">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              {isUploading ? 'Uploading...' : (profilePhoto && profilePhoto !== '/default-profile.png' ? 'Change Photo' : 'Upload Photo')}
            </Button>
      ...
      <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <Fieldset>
            ...
            />
            <Text className="text-sm text-gray-500 mt-1">This is your login email and cannot be changed</Text>
          </Fieldset>
          <Fieldset>
      ...
      <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
        <div className="space-y-1">
          ...
          <Text>Connect your Google account to automatically create calendar events and Google Meet links for your coaching sessions.</Text>
        </div>
        <div className="space-y-4">
