...
export function Address({ initialAddress, onAddressChange }: AddressProps) {
  ...
  if (loading) {
    return (
      <div className="grid grid-cols-2 gap-6">
        <div className="col-span-2 h-10 bg-gray-200 rounded animate-pulse" />
        <div className="col-span-2 h-10 bg-gray-200 rounded animate-pulse" />
  ...
  const hasAddressData = addressData.streetAddress || addressData.city || addressData.state || addressData.zipCode
