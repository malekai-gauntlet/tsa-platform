...
function LockedSidebarItem({ children, title, isCollapsed = false }: { children: React.ReactNode, title: string, isCollapsed?: boolean }) {
  ...
  return (
    ...
    >
      {children}
      <LockClosedIcon className="absolute right-2 top-1/2 transform -translate-y-1/2 h-4 w-4 text-white/60" />
      ...
      {showTooltip && (
        <div className={`absolute z-50 px-2 py-1 text-xs text-white bg-gray-900 rounded shadow-lg whitespace-nowrap ${
          isCollapsed 
            ...
            : 'left-1/2 top-full transform -translate-x-1/2 mt-2'
        }`}>
          Coming Soon
          <div className={`absolute w-2 h-2 bg-gray-900 transform rotate-45 ${
            isCollapsed 
              ? 'left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2' 
              : 'left-1/2 bottom-full transform -translate-x-1/2 translate-y-1/2'
          }`} />
        </div>
      )}
    </div>
        ...
        <Sidebar className="w-full h-full">
          ...
          <SidebarBody>
            <SidebarSection>
              ...
              <SidebarItem href="/coach/tuition" current={pathname.startsWith('/coach/tuition')} onClick={() => setMobileMenuOpen(false)}>
        ...
        <Sidebar className="w-full h-full relative" data-tour="sidebar">
          ...
          <SidebarBody>
            <SidebarSection>
              ...
              <SidebarItem href="/coach/applications" current={pathname.startsWith('/coach/applications')} data-tour="applications-section">
              ...
              <SidebarItem href="/coach/tuition" current={pathname.startsWith('/coach/tuition')} data-tour="tuition-section">
