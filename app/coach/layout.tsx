...
function OriginalCoachLayout({ children }: { children: React.ReactNode }) {
...
function CoachLayout({ children }: { children: React.ReactNode }) {
  if (USE_REFACTORED_LAYOUT) {
    return <CoachLayoutRefactored>{children}</CoachLayoutRefactored>;
  }
  return <OriginalCoachLayout>{children}</OriginalCoachLayout>;
}
