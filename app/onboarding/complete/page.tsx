...
export default function Complete() {
          ...
          if (completionError instanceof Error && 
            ...
            try {
              ...
              const sessionCreated = await invitationAPI.updateOnboardingProgress(
                ...
                ['personal-info', 'role-experience', 'school-setup', 'school-focus', 'student-planning', 'agreements'], // completed steps
  ...
  const completeOnboardingWithAppSync = async (structuredData: OnboardingData): Promise<OnboardingResponse & {
    ...
    console.log('🚀 Starting onboarding completion via direct GraphQL...')
    ...
    try {
      ...
      const completionData = {
        ...
        completed_steps: [
          ...
          'SCHOOL_FOCUS', 'STUDENT_PLANNING', 'AGREEMENTS', 'FINALIZE'
        ],
