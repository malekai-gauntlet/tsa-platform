  ...
  useEffect(() => {
    ...
    const fetchApplications = async () => {
      ...
      try {
        ...
        const transformedApplications: Application[] = studentApplications.map((studentApp: any) => ({
        ...
        console.log(`✅ Successfully loaded ${transformedApplications.length} applications for coach: ${coachEmail}`)
