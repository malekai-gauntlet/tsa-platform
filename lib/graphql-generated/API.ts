...
export enum ParentApplicationEnrollmentType {
  AFTER_SCHOOL = 'AFTER_SCHOOL',
  FULL_TIME = 'FULL_TIME',
  PART_TIME = 'PART_TIME',
}
...
export type ParentApplicationMutationVariables = {
  academicYear?: string | null;
  address?: string | null;
  coachName?: string | null;
  emergencyContact?: string | null;
  enrollmentType?: ParentApplicationEnrollmentType | null;
...
export type ParentApplicationMutation = {
  parentApplication?: string | null;
};
