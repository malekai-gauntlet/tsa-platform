...
export function TouchTarget({ children }: { children: React.ReactNode }) {
  return (
    <>
      <span
        className="pointer-events-none absolute top-1/2 left-1/2 size-[max(100%,2.75rem)] -translate-x-1/2 -translate-y-1/2 pointer-fine:hidden [@media(hover:none)]:pointer-events-auto"
        aria-hidden="true"
      />
      {children}
    </>
